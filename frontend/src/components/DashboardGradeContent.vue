<template>
  <v-container fluid class="pa-0">
    <!-- Hero Header -->
    <div
      class="hero-section pa-8 pa-md-12 mb-6"
      :style="{ borderBottom: `4px solid ${currentTheme.primary}22` }"
    >
      <v-row align="center">
        <v-col cols="12" md="8">
          <v-chip
          ...
          <p
            class="text-body-1 text-md-h6 text-medium-emphasis max-width-600 font-weight-regular"
          >
            Bienvenido a tu aventura matemática. Prepárate para completar las
            misiones del grado {{ selectedGrade }}°.
          </p>
        </v-col>
      ...
      <v-card class="rounded-xl overflow-hidden glass-tabs" elevation="2">
        <div class="pa-6 pa-md-8 pb-0">
          ...
          <p class="text-body-1 text-medium-emphasis mb-4">
            Observa estos videos introductorios antes de comenzar con tus
            misiones y descubre de qué trata nuestra aventura.
          </p>
        </div>
        ...
        <v-row no-gutters class="px-4 px-md-6 pb-6 pt-2">
          ...
          <v-col cols="12" md="6" class="pa-2">
            <v-card
              elevation="6"
              class="rounded-xl overflow-hidden bg-black d-flex align-center justify-center"
              style="
                aspect-ratio: 16/9;
            ...
            >
              ...
              >
                ...
                <source
                  :src="`/videos/grado${selectedGrade}_video1.mp4`"
                  type="video/mp4"
                />
                Tu navegador no soporta el formato de video.
              </video>
            </v-card>
            <div class="text-center mt-3 font-weight-bold text-medium-emphasis">
          ...
          <v-col cols="12" md="6" class="pa-2 mt-4 mt-md-0">
            ...
            >
              ...
              >
                ...
                <source
                  :src="`/videos/grado${selectedGrade}_video2.mp4`"
                  type="video/mp4"
                />
                Tu navegador no soporta el formato de video.
              </video>
    ...
    <v-container class="px-8 pb-12 pt-4 text-center">
      <v-card flat class="rounded-xl pa-12 glass-tabs border" elevation="0">
        <v-icon
          size="80"
          :color="currentTheme.primary"
          class="mb-6 animate__animated animate__bounce animate__infinite"
        ...
        <p class="text-h6 text-medium-emphasis mb-8 max-width-600 mx-auto">
          Pon a prueba lo que has aprendido en nuestras misiones interactivas.
