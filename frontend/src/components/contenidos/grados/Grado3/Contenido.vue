<template>
  <div class="grade-content">
    ...
    <header class="mb-8">
      ...
      <p class="text-h6 text-medium-emphasis">Descubre nuevos conceptos para el Grado 3.</p>
    </header>
    ...
    <v-card class="rounded-2xl overflow-hidden glass-card" border="1">
      ...
      <v-window v-model="tab" class="pa-6 pa-md-10">
              ...
              <v-card class="rounded-xl overflow-hidden border shadow-sm" elevation="0">
                <div class="video-container bg-black">
                  ...
                  <video controls class="w-100 h-100">
                    <source :src="`/videos/grado3_video${n}.mp4`" type="video/mp4" />
        ...
        <v-window-item value="texto">
          <h2 class="text-h4 font-weight-black mb-6">Conceptos Clave de Grado 3°</h2>
          
          <!-- INSTRUCCIÓN: Escribe aquí el contenido teórico -->
          <p class="text-body-1 mb-4">
            Las matemáticas en el grado 3 se enfocan en fortalecer tus habilidades de razonamiento. 
    ...
    <div class="mt-12 d-flex justify-end">
      <v-btn size="x-large" color="primary" class="rounded-xl px-8" elevation="8" :to="`/app/grado/3/actividades`">
